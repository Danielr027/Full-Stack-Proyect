...
function CreateStorePage() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            // Obtener el storeId de la respuesta (ajusta según tu backend)
            const createdStoreId = response.data.store._id; // Asegúrate de que esta ruta es correcta
                        ...
                        <div className="bg-white rounded-md shadow-lg px-4 py-6">
                            <div className="flex flex-col items-center">
                                ...
                                <Dialog.Description className="mt-2 text-sm leading-relaxed text-center text-gray-500">
                                    Tu comercio ha sido creado exitosamente. A continuación, se muestra su ID (debes pasárle el ID del comercio al usuario Merchant asociado para que pueda crear la página web):
                                </Dialog.Description>
                                {/* ID del Comercio con Botón de Copia */}
                                {storeId && (
                                    <div className="p-2 border rounded-lg flex items-center justify-between mt-4 w-full">
                                        ...
                                        <button
                                            ...
                                            onClick={handleCopy}
                                            aria-label="Copiar ID del Comercio"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-6 w-6"
